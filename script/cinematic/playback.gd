class_name CinematicPlayback extends Node
...
var sequence_queue: Array[CinematicSequence]
...
func enqueue(sequence: CinematicSequence):
...
func _play_next_sequence():
	if queue_empty():
		return
	var sequence: CinematicSequence = sequence_queue.pop_front()
...
func _on_track_finished(_track: CinematicTrackBase, id: int):
