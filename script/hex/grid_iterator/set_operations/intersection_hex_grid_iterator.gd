@tool
class_name IntersectionHexGridIterator extends HexGridIteratorBase
...
func _iter_init(arg) -> bool:
	...
	if _gridB.has_point(_current_hex):
		return true
	return _find_next_intersection(arg)
